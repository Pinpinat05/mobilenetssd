...
lineaccesstoken = 'HFl6WTh2lgX3oygMnZDppRu8CjJcVcprzirmDWb5K46jDV/3giTpA11uUv3dwnKE7oYiw4mImc54vUssztB8iEHThjLI73URTZdtpEs8vUCmKK5kctHaQa26KoVglFj885n4/uzGYBXLSEOTh1sSAgdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี") :
            replyObj = TextSendMessage(text="เออ...หวัดดี")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "กินข้าวรึยัง"):
            replyObj =TextSendMessage(text="ยังไม่ได้กิน")
            line_bot_api.reply_message(rtoken, replyObj)
            ...
            json_headers.update({'Host':'bots.dialogflow.coloud.google.com'})
